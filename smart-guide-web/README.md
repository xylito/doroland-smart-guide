...
> ⚠️ **주의사항:** 훌륭한 요원은 동료에게 구체적이고 명확하게 지시해야 합니다! AI에게 다음과 같이 명령해 보세요.
...
*   **🐛 에러 대처 명령:** 화면에 데이터가 안 뜰 때는 당황하지 마세요! *"요원! 화면에 데이터가 안 떠. 무슨 에러가 났는지 스스로 분석하고 코드를 고쳐줘!"* 라고 명령하세요.
...
1.  **나만의 테마 적용:** 배경 이미지, 버튼 색상, 글씨체를 내가 좋아하는 테마로 완전히 바꿔달라고 지시하기!
